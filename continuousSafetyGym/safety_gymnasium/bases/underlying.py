...
import continuousSafetyGym.safety_gymnasium.assets.free_geoms as free_geoms
import continuousSafetyGym.safety_gymnasium.assets.geoms as geoms
import continuousSafetyGym.safety_gymnasium.assets.mocaps as mocaps
from continuousSafetyGym.safety_gymnasium import agents
from continuousSafetyGym.safety_gymnasium.assets.color import COLOR
from continuousSafetyGym.safety_gymnasium.assets.free_geoms import FREE_GEOMS_REGISTER
from continuousSafetyGym.safety_gymnasium.assets.geoms import GEOMS_REGISTER
from continuousSafetyGym.safety_gymnasium.assets.mocaps import MOCAPS_REGISTER
from continuousSafetyGym.safety_gymnasium.bases.base_object import FreeGeom, Geom, Mocap
from continuousSafetyGym.safety_gymnasium.utils.common_utils import MujocoException
from continuousSafetyGym.safety_gymnasium.utils.keyboard_viewer import KeyboardViewer
from continuousSafetyGym.safety_gymnasium.utils.random_generator import RandomGenerator
from continuousSafetyGym.safety_gymnasium.world import World
...
class Underlying(abc.ABC):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, config: dict | None = None) -> None:
        ...
        Args:
            config (dict): Configuration dictionary, used to pre-config some attributes
                according to tasks via :meth:`continuousSafetyGym.safety_gymnasium.register`.
        """
    ...
    def _get_viewer(
        ...
        continuousSafetyGym.safety_gymnasium.utils.keyboard_viewer.KeyboardViewer
