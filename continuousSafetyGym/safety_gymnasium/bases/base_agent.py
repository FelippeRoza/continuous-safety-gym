...
from continuousSafetyGym.safety_gymnasium.utils.task_utils import get_body_xvelp, quat2mat
...
class BaseAgent(abc.ABC):  # pylint: disable=too-many-instance-attributes
    ...
    def _load_model(self) -> None:
        ...
        Note:
            ...
            :class:`continuousSafetyGym.safety_gymnasium.World` via :meth:`set_engine`.
        """
