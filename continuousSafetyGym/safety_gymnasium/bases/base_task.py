...
from continuousSafetyGym.safety_gymnasium.bases.underlying import Underlying
from continuousSafetyGym.safety_gymnasium.utils.common_utils import ResamplingError, camel_to_snake
from continuousSafetyGym.safety_gymnasium.utils.task_utils import theta2vec
...
class BaseTask(Underlying):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    - :meth:`calculate_cost`: Determine costs depending on the agent and obstacles, actually all
      cost calculation is done in different :meth:`continuousSafetyGym.safety_gymnasium.bases.base_obstacle.BaseObject.cal_cost`
    ...
    def _build_static_geoms_config(self, geoms_config: dict) -> None:
        ...
        base_dir = os.path.dirname(continuousSafetyGym.safety_gymnasium.__file__)
    ...
    def specific_step(self) -> None:
        ...
        It will be called when :meth:`continuousSafetyGym.safety_gymnasium.builder.Builder.step()` is called using env.step().
