...
from continuousSafetyGym.safety_gymnasium.utils.registration import make as safety_make
from continuousSafetyGym.safety_gymnasium.vector.async_vector_env import SafetyAsyncVectorEnv
from continuousSafetyGym.safety_gymnasium.vector.sync_vector_env import SafetySyncVectorEnv
...
def make(
    ...
    **kwargs,
    ...
    Example::
        ...
        >>> env = continuousSafetyGym.safety_gymnasium.vector.make('SafetyPointGoal1-v0', num_envs=3)
    ...
    Args:
        ...
        **kwargs: Keywords arguments applied during `continuousSafetyGym.safety_gymnasium.make`
    """
