...
from . import bases, sensors, agents
from .obstacles import GoalZone, LineBoundary, CircleZone, \
    Puck, Apple, Bomb
...
class ReachGoalTask(bases.Task):
    ...
    def calculate_cost(self):
        ...
        a_pos = self.agent.get_position()[:2]
        cs = dict(
        ...
        cs['cost'] = distance_list
        cs['cost_max'] = max(distance_list)
